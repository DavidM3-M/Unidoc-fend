...
const DetalleContratacionAdminModal = ({ idContratacion, isOpen, onClose }: Props) => {
  ...
  const fetchDetalle = useCallback(async () => {
    try {
      ...
      const [contratoRes, bitacoraRes] = await Promise.all([
        axiosInstance.get(`/admin/obtener-contratacion/${idContratacion}`),
        axiosInstance.get(`/admin/obtener-contratacion/${idContratacion}/bitacora`),
      ]);
...
export default DetalleContratacionAdminModal;
