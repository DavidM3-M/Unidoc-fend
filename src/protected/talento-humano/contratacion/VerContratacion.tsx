      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link to="/talento-humano/aspirantes-aprobados">
            <div className="group flex items-center gap-2 bg-[#c89b14] hover:bg-[#a67c0a] text-white px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 shadow-sm hover:shadow-md">
