...
const Coordinador = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900/5 via-white to-amber-50/10 p-4 md:p-6 lg:p-8">
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Link to="/coordinador/aspirantes">
            <div className="group bg-white rounded-2xl border border-gray-100 shadow-md hover:shadow-xl hover:shadow-orange-100 hover:border-orange-300 transition-all duration-300 hover:-translate-y-1 p-6 flex flex-col gap-5 h-full cursor-pointer">
              <div className="flex items-start justify-between">
                <div className="p-4 rounded-xl shadow-md bg-gradient-to-br from-orange-600 to-orange-700">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      <div>
        ...
        <select
          ...
          className="w-full p-2.5 border border-gray-200 rounded-xl bg-white text-sm focus:ring-2 focus:ring-orange-300 focus:border-orange-400 outline-none transition"
        >
      ...
      <div>
        ...
        <input
          type="date"
          className="w-full p-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-orange-300 focus:border-orange-400 outline-none transition"
          value={dateFrom ?? ""}
      ...
      <div className="sm:col-span-2 lg:col-span-4 flex gap-2 justify-end pt-1">
        ...
        <button
          ...
          className="px-4 py-2 rounded-xl bg-orange-600 hover:bg-orange-700 text-white text-sm font-medium transition"
        >
          Exportar
        </button>
      </div>
